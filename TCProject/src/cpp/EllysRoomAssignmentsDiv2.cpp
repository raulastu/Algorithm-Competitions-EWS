...
public:
    double getProbability(vector <string> ratings) {
        ...
        debug(v.size());
        debugv(v);
        if(distance(v.begin(),idx)==0){
            return 1;
        }
        if(distance(v.begin(),idx)<R){
            return 0;
        }
        return 1/(double)R;
    }
...
int main( int argc, char* argv[] ) {
    {
        string ratingsARRAY[] = {"724 42 13 17 1199 577 1001 1101 483 845 196 1163 3", "60 985 296 1044 917 1007 898 119 1016 23 56 1159 1",
        ...
        EllysRoomAssignmentsDiv2 theObject;
        eq(0, theObject.getProbability(ratings),0.3333333333333333);
    }
    {
        string ratingsARRAY[] = {"42 911 666 17 13 1 1155 1094 815 5 1000 540"};
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv2 theObject;
        eq(1, theObject.getProbability(ratings),1.0);
    }
    {
        string ratingsARRAY[] = {"1168 196 440 643 227 1194 1149 372 878 23 767 296 ", "110 52 840 367 790 884 620 676 380 1007 304 262 10",
        ...
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv2 theObject;
        eq(2, theObject.getProbability(ratings),0.0);
    }
    {
        string ratingsARRAY[] = {"1013 1124 1103 1154 1038 1159 1084 1114 1151 1158 ", "1088 1015 1096 1169 1018 1073 1104 1035 1091 1133 ", "1140"};
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv2 theObject;
        eq(2, theObject.getProbability(ratings),0.5);
    }
    {
        string ratingsARRAY[] = {"539 457 277 929 180 296 820 319 839 199 210 989 88", "5 1033 1132 479 1023 425 340 828 843 934 1124 434 ", "264 206 1117 569 388 351 972 348 176 1182 832"};
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv2 theObject;
        eq(2, theObject.getProbability(ratings),0.5);
    }
    ...
    {
        string ratingsARRAY[] = {"470 840 410 1168 637 464 498 1118 276 1013 989 874", " 64 192 296 611 44 999 583 365 1195 20 838 274 425",
        ...
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv2 theObject;
        eq(3, theObject.getProbability(ratings),0.037037037037037035);
    }
}
// END CUT HERE
