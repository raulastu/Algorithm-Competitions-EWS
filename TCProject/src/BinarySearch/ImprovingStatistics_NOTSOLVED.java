...
public class ImprovingStatistics_NOTSOLVED {
...
//        double st = (int)((played / (double) won)*100);
        double s = (w * 100 / (double) p);
//        System.err.println(won / (double) played * 100 + " " + won + " " + " " + played + " " + s);
        for (double i = 1; true; i++) {
            double s2 = (((w + i) * 1.0 * 100 / (double) (p + i)));
