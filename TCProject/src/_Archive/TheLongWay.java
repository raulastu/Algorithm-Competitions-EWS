...
// BEGIN CUT HERE
    ...
    public static void main(String[] args) {
        try {
            eq(0, (new TheLongWay()).minimalTime(new String[]{
                        "SCC",
                        "..."}), 4);
            eq(1, (new TheLongWay()).minimalTime(new String[]{"C.C.S"}), -1);
            eq(2, (new TheLongWay()).minimalTime(new String[]{"#.#",
                        "CSC",
                        "#.#"}), 5);
            eq(3, (new TheLongWay()).minimalTime(new String[]{"#.#....",
                        "##...#.",
                        "C#...#.",
                        ".....#.",
                        "..#....",
                        ...
                        "..C.#.#",
                        "###.#.."}), 24);
            eq(4, (new TheLongWay()).minimalTime(new String[]{
                        "#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#C",
                        ".................S..................",
                        "C#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#.#"
                    }), 155);
            eq(4, (new TheLongWay()).minimalTime(new String[]{".....#.###....", "..##.#.......#", "....#.#.....#.", "#..###.##.....", ".#.......#....", "..##.##.......", ".#...#...##.#.", ".#.....#.....#", "...#....#....#", "...#....#....#", ".#............", "....#.#..#.#.S", "...........#..", "....#.#.......", "##...#...#....", ".###.##C...##.", "#..C#..#...#..", ".#....#....#.."}), -1);
            eq(4, (new TheLongWay()).minimalTime(new String[]{
                        ".................##.....#..",
                        "..##.#......#.............#",
                        "....#.......#.#...#....#.#.",
