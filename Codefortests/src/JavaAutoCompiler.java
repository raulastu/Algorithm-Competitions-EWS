...
public class JavaAutoCompiler implements Runnable {
...
//		Runtime.getRuntime().exec("java _C_runner");
	...
	public JavaAutoCompiler(String folder) {
		this.folder=folder;
		t = new Thread(this);
		t.start();
	}
	...
	public static void main(String[] args) throws Exception {
		JavaAutoCompiler main = new JavaAutoCompiler("/Users/rc/Eclipse-Workspaces/Algorithm-Competitions-EWS/CFProject/src/");
		main.loadSnapshot();
		main.check();
	}
